...
$section->addText('(Dùng cho câu hỏi thi tự luận, vấn đáp)', $subtitleStyle);
$section->addTextBreak(1);
...
$table->addCell(1500, $headerCellStyle)->addText('Điểm (Mỗi ý từ 0,25 -0,5 đ)', $boldTextStyle);
...
$objWriter->save('mau_bang_ngan_hang_tu_luan.docx');

echo "Đã tạo file mẫu tự luận thành công!";
?> 